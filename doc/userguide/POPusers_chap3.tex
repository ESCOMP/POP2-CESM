...
pressure is solved.  Four solver methods are available,
all iterative (preconditioned conjugate gradient, a
Chronopouos-Gear form of pcg requiring fewer global
reductions, 
...
\hline
  solv\_type            &
  [`pcg'], `cg1', `cgr', `jac' &
  preconditioned conjugate gradient OR Chronopoulis-Gear pcg OR
      conjugate gradient residual OR jacobi \\
\hline
  lprecond  &
  [.false.] &
