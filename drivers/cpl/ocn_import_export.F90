...
!-----------------------------------------------------------------------
      ...
      do i=this_block%ib,this_block%ie
         ...
         if (index_x2o_Fioi_flxdst > 0) &
            DUST_FLUX(i,j,iblock) = DUST_FLUX(i,j,iblock) + &
               0.1_r8 * RCALCT(i,j,iblock) * (x2o(index_x2o_Fioi_flxdst,n))
         ...
         if (index_x2o_Fioi_bcpho > 0 .and. index_x2o_Fioi_bcphi > 0) &
            BLACK_CARBON_FLUX(i,j,iblock) = BLACK_CARBON_FLUX(i,j,iblock) + &
               0.1_r8 * RCALCT(i,j,iblock) * ( &
