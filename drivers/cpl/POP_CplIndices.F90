...
contains
  ...
  subroutine POP_CplIndicesSet( )
    ...
    index_x2o_Fioi_bcpho    = mct_avect_indexra(x2o,'Fioi_bcpho',perrWith='quiet')
    index_x2o_Fioi_bcphi    = mct_avect_indexra(x2o,'Fioi_bcphi',perrWith='quiet')
    index_x2o_Fioi_flxdst   = mct_avect_indexra(x2o,'Fioi_flxdst',perrWith='quiet')
