...
def diagnostics_to_tavg_and_operators(ecosys_diagnostics_in, tavg_contents_out, MARBL_diagnostics_operator_out,
                                      append, lMARBL_tavg_all, lMARBL_tavg_alt_co2, frequency_streams):

    import os, sys, logging
    logger = logging.getLogger("__name__")
    labort = False
    in_MARBL_diags = False
    processed_vars = []
    ...
    for line in all_lines:
        if "MARBL-generated diagnostics" in line:
            in_MARBL_diags = True
...
if __name__ == "__main__":
    ...
    diagnostics_to_tavg_and_operators(args.ecosys_diagnostics_in, args.tavg_contents_out,
