...
class MARBL_diagnostics_for_POP(object):
    def __init__(self, MARBL_dir, caseroot, MARBL_settings):
        ...
        MARBL_args["default_diagnostics_file"] = os.path.join(caseroot,"SourceMods","src.pop","default_diagnostics.json")
        if not os.path.isfile(MARBL_args["default_diagnostics_file"]):
            MARBL_args["default_diagnostics_file"] = os.path.join(MARBL_dir, "autogenerated_src", "default_diagnostics.json")
