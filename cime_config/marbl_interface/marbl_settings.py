...
class MARBL_settings_for_POP_class(object):
    def __init__(self, marbl_dir, caseroot, srcroot, ocn_grid, settings_class_dir):
        ...
        # User can put default_values.yaml in SourceMods, otherwise use file provided by MARBL
        ...
        MARBL_args["file_is_JSON"] = True

        # User can modify user_settings_marbl in caseroot
        MARBL_args["input_file"] = os.path.join(caseroot, "user_settings_marbl")
