...
99  call broadcast_scalar(stat, master_task)
  ...
  subroutine ecosys_ciso_tavg_forcing()
    ...
    do iblock = 1,nblocks_clinic
       associate(FLUX_DIAGS => ECO_CISO_SFLUX_TAVG(:,:,:,iblock))
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_FG_13CO2)       , tavg_CISO_DI13C_GAS_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_FG_as_13CO2)    , tavg_CISO_DI13C_AS_GAS_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_FG_sa_13CO2)    , tavg_CISO_DI13C_SA_GAS_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_FG_d13C)        , tavg_CISO_d13C_GAS_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_R13C_DIC_surf)  , tavg_CISO_R13C_DIC_surf,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_R13C_atm)       , tavg_CISO_R13C_atm,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_D13C_atm)       , tavg_CISO_D13C_atm,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_eps_aq_g_surf)  , tavg_CISO_eps_aq_g_surf,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_eps_dic_g_surf) , tavg_CISO_eps_dic_g_surf,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_FG_14CO2)       , tavg_CISO_DI14C_GAS_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_FG_as_14CO2)    , tavg_CISO_DI14C_AS_GAS_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_FG_sa_14CO2)    , tavg_CISO_DI14C_SA_GAS_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_R14C_DIC_surf)  , tavg_CISO_R14C_DIC_surf,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_R14C_atm)       , tavg_CISO_R14C_atm,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_D14C_atm)       , tavg_CISO_D14C_atm,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_FG_d14C)        , tavg_CISO_d14C_GAS_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_DI13C_RIV_FLUX)      , tavg_CISO_DI13C_RIV_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_DO13C_RIV_FLUX)      , tavg_CISO_DO13C_RIV_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_DI14C_RIV_FLUX)      , tavg_CISO_DI14C_RIV_FLUX,iblock,1)
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_DO14C_RIV_FLUX)      , tavg_CISO_DO14C_RIV_FLUX,iblock,1)
       !debugging
       call accumulate_tavg_field(FLUX_DIAGS(: ,:,buf_ind_CISO_GLOBAL_D14C)    , tavg_CISO_GLOBAL_D14C,iblock,1)
       end associate
    end do
