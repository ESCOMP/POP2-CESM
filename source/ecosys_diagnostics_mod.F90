...
contains
  ...
  subroutine ecosys_diagnostics_init(marbl_interior_diags,                    &
                                     marbl_restore_diags, tracer_d_module)
    ...
    do n=1,ecosys_tracer_cnt
      ...
      call marbl_restore_diags%add_diagnostic(lname, sname, units, vgrid,     &
                                              .false., tmp_id)
    end do
